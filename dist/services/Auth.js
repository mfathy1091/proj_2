...
var hashingService = __importStar(require("../utils/hashing"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var pepper = process.env.BCRYPT_PASSWORD;
var AuthService = /** @class */ (function () {
    function AuthService() {
    }
    AuthService.prototype.login = function (email, plainTextPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, user, hashedPassword, isPasswordValid, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        sql = 'SELECT id, email, first_name, last_name, password FROM users WHERE email=($1)';
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, hashingService.isPasswordValid(plainTextPassword, hashedPassword)];
                    case 4:
