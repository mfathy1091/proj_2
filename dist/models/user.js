    ...
    update(userId, u) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield connection.query(sql, [u.first_name, u.last_name, u.email, u.password, userId]);
                connection.release();
    ...
    delete(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new Error(`Could not delete user ${userId}. Error:  ${err.message}`);
            }
        });
    }
}
